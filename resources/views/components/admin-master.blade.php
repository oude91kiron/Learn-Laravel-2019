...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- S33/228 Only the user that an admin can see user links -->
      ...
      <!-- Divider -->
      <hr style="margin-top:50%" class="sidebar-divider d-none d-md-block">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <x-admin.top-nav.admin-top-navbar-user-information></x-admin.top-nav.admin-top-navbard-user-information>
...
"></script>
  ...
  <!-- Note: use the yield method so we yield script files
             only for the pages that need this files (look admin/posts/index.php) -->
  @yield('scripts') 
